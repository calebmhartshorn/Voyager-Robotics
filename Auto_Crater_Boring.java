...
@Autonomous
public class Auto_Crater_Boring extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        rotate(22);
        drive(DRIVE_SPEED, -15, -15, 10);
        rotate(22);
        drive(DRIVE_SPEED, -20, -20, 20.0);
        slideDrop();
        rotate(-5);
        drive(DRIVE_SPEED * 1.5, 76, 76, 20.0);
        rotate(10);
